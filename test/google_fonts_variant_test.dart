...
main() {
  ...
  testWidgets('fromFontJson() works for no weight and no style in json',
      (tester) async {
    final variant = GoogleFontsVariant(
      fontWeight: FontWeight.w400,
      fontStyle: FontStyle.normal,
    ...
    expect(
      GoogleFontsVariant.fromFontJson({
        'asset': 'foo',
      }),
      equals(variant),
    );
  ...
  testWidgets('fromFontJson() works for no weight and italic style in json',
      (tester) async {
    final variant = GoogleFontsVariant(
      fontWeight: FontWeight.w400,
      fontStyle: FontStyle.italic,
  ...
  testWidgets('fromFontJson() works for weight 500 and no style in json',
      (tester) async {
    final variant = GoogleFontsVariant(
      fontWeight: FontWeight.w500,
      fontStyle: FontStyle.normal,
  ...
  testWidgets('fromFontJson() works for weight 500 and italic style in json',
      (tester) async {
    final variant = GoogleFontsVariant(
      fontWeight: FontWeight.w500,
      fontStyle: FontStyle.italic,
