...
class FileSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FileSpec', package: const $pb.PackageName('fonts'), createEmptyInstance: create)
    ..aOS(1, 'filename')
    ..aInt64(2, 'fileSize')
  ...
  FileSpec copyWith(void Function(FileSpec) updates) => super.copyWith((message) => updates(message as FileSpec));
...
class IntRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IntRange', package: const $pb.PackageName('fonts'), createEmptyInstance: create)
  ...
  IntRange copyWith(void Function(IntRange) updates) => super.copyWith((message) => updates(message as IntRange));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FloatRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FloatRange', package: const $pb.PackageName('fonts'), createEmptyInstance: create)
  ...
  FloatRange copyWith(void Function(FloatRange) updates) => super.copyWith((message) => updates(message as FloatRange));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Font extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Font', package: const $pb.PackageName('fonts'), createEmptyInstance: create)
  ...
  Font copyWith(void Function(Font) updates) => super.copyWith((message) => updates(message as Font));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FontFamily extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FontFamily', package: const $pb.PackageName('fonts'), createEmptyInstance: create)
    ..aOS(1, 'name')
  ...
  FontFamily copyWith(void Function(FontFamily) updates) => super.copyWith((message) => updates(message as FontFamily));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Directory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Directory', package: const $pb.PackageName('fonts'), createEmptyInstance: create)
    ..pc<FontFamily>(1, 'family', $pb.PbFieldType.PM, subBuilder: FontFamily.create)
